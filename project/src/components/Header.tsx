...
const pageTitles: Partial<Record<NavPage, { title: string; subtitle: string }>> = {
  dashboard: { title: 'Dashboard', subtitle: 'Operational summary and financial KPI snapshots.' },
  campaigns: { title: 'Campaigns', subtitle: 'Live offer catalog with filters, scopes, and workflow actions.' },
  manageCampaigns: { title: 'Request Offers', subtitle: 'Offer request pipeline and approval operations.' },
  createCampaign: { title: 'Create offer', subtitle: 'Multipart form for POST /offer/createOffer' },
  publishers: { title: 'Affiliates', subtitle: 'Publisher quality, onboarding, and contact management.' },
  publishersManage: { title: 'Managers', subtitle: 'Manager allocation and operations controls.' },
  advertisers: { title: 'Advertisers', subtitle: 'Advertiser profiles, managers, and status controls.' },
  postbackLogs: { title: 'Postback', subtitle: 'Postback logs, retry queues, and API event diagnostics.' },
  reports: { title: 'Performance', subtitle: 'Revenue and conversion performance monitoring.' },
  conversionReport: { title: 'Analytics', subtitle: 'Conversion analytics and event-level intelligence.' },
  impressionReport: { title: 'Impressions', subtitle: 'Impression-level reporting and quality checks.' },
  additionalReports: { title: 'Validation', subtitle: 'Data validation and discrepancy review tools.' },
  integration: { title: 'Integrations', subtitle: 'External integrations and network connectivity.' },
  contacts: { title: 'Affiliates', subtitle: 'Manage affiliate relationships and live contact details.' },
